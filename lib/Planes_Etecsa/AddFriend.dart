...
class _DeleteFriendState extends State<AddFriend> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Theme.of(context).primaryColor,
        elevation: 0,
        title:Text('Agregar Amigo',style: TextStyle(fontFamily: 'Ubuntu',fontWeight: FontWeight.bold),),
